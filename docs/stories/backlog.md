...
US-020 are `implemented` (E04 complete; E05 in progress with US-019/US-020
done); US-021 through US-028 remain `planned`. Design
...
| E05-planning-contribution | Routes, work/date planners, check-in, clips | Batch 4 | US-019..022 | in progress (US-019/020 done) |
...
(US-019 and US-020 done); continue with US-021 and US-022, then E06 and E07.
